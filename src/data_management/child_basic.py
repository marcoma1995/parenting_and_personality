...
# Extract relevant variables contained in bioage17 but not in jugendl + identifiers.
bioage17_relevant = bioage17_raw.loc[:,['hhnr','persnr','syear','sex','bygebjah','bymnr','byvnr']]
bioage17_relevant.columns=['cid','pid','syear','sex','birth_year','pid_mother','pid_father']
bioage17_relevant
